...
@!
 ...
 72     3    ! NUMVTX Number of VTX layers ( those used for tracking)
...
@! layer #0 (beampipe) 
 ...
 78  -280.   ! Z-(cm)
 79   280.   ! Z+(cm)
 80   0.00007  ! thickness in radiation length
@! 80   0.0007  ! thickness in radiation length
@! layer #1
 81     1.9  ! radius (cm)
 82    -3.92  ! Z-(cm)
 83     3.92  ! Z+(cm)
 84   0.0002134  ! thickness in radiation length
@! 84   0.002134  ! thickness in radiation length
@! layer #2 
 85     4.1  ! radius (cm)
 86    -8.47  ! Z-(cm)
 87     8.47  ! Z+(cm)
 88   0.002134  ! thickness in radiation leng5h
@! layer #3
 89     6.3  ! radius (cm)
 90   -13.01  ! Z-(cm)
 91    13.01  ! Z+(cm)
 92   0.002134  ! thickness in radiation length
@! 
@! Following is a parmeter set for Intermidiate tracker.
@! This parameter sets are determined so as to
@!    (1) 4 layers to allow self tracking.
...
@! layer #5 (IT 1)
 ...
 94   -19.2 ! Z-(cm)
 95    19.2 ! Z+(cm)
 96   0.006403  ! thickness in radiation length
@! layer #6 (IT 2)
 97    17.8  ! radius (cm)
 98   -36.75  ! Z-(cm)
 99    36.75  ! Z+(cm)
100   0.006403  ! thickness in radiation length
@! layer #7 (IT 3)
101    26.3  ! radius (cm)
102   -54.3  ! Z-(cm)
103    54.3  ! Z+(cm)
104   0.006403  ! thickness in radiation length
@! layer #8 (IT 4)
105    34.8  ! radius (cm)
106   -71.85  ! Z-(cm)
107    71.85  ! Z+(cm)
108   0.006403  ! thickness in radiation length
@!          .........
@!          .........
...
110  -235.   ! Z-(cm)
111   235.   ! Z+(cm)
112   0.026524   ! thickness in radiation length
@!
@!          .........                                                          
