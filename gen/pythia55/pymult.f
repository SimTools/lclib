...
C...Evaluate overlap integrals.
  ...
  140     B=B+DELTAB
          ...
          ELSE
            CQ2=PARP(84)**2
C A.Miyamoto modified to suppress EXP Underflow message
C            OV=((1.-PARP(83))**2*EXP(-MIN(100.,B**2))+2.*PARP(83)*
            OV=((1.-PARP(83))**2*EXP(-MIN(85.,B**2))+2.*PARP(83)*
     &      (1.-PARP(83))*2./(1.+CQ2)*EXP(-MIN(100.,B**2*2./(1.+CQ2)))+
C     &      PARP(83)**2/CQ2*EXP(-MIN(100.,B**2/CQ2)))/PARU(2)
     &      PARP(83)**2/CQ2*EXP(-MIN(85.,B**2/CQ2)))/PARU(2)
          ENDIF
