...
C CHECK ON CORRECT LABEL INPUT
     ...
     .  ' RKZSF: ERROR L1=',L1,' L2=',L2,' IP1=',IP1,' IP2=',IP2
       STOP
      ENDIF
C CHECK WHETER THIS ONE WAS ALREADY COMPUTED
C DONS(,,,)=0: NOT YET COMPUTED, DONS(,,,)=1: ALREADY COMPUTED
C IF NOT YET COMPUTED: COMPUTE IT, AND STORE IN ARRAY 'ANSS'
C IF ALREADY COMPUTED: GET THE RESULT FROM ARRAY 'ANSS'
